                ...
                <tr>
                    <td>
                        <form id="download-form" action="{{ route('front.download_vat_receipt') }}" method="GET">
                            <input type="hidden" name="payment_date" value="{{ $quote_by_transporter->updated_at }}">
                            <input type="hidden" name="total" value="{{ $quote_by_transporter->deposit }}">
                            <input type="hidden" name="vehicle_name" value="{{ $user_info->vehicle_make . ' ' . $user_info->vehicle_model }}">
                        </form>
