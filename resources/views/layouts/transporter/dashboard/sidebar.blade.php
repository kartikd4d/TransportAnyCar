...
<div class="modal fade" id="importantNoticeModal" tabindex="-1" role="dialog" aria-labelledby="importantNoticeLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content maintaince_text">
      ...
      <div class="modal-body ">
        <p>The websitee is currently undergoing maintenance as there have been some technical issues and bugs that need to be fixed. There will not be any new jobs posted on the find jobs section until the bugs have been resolved.</p>
