                    ...
                    <div class="admin_job_bx find_trans_newjob" id="style-1">
                        ...
                        <div class="container">
                            ...
                            <div class="job-data">
                                ...
                                @else
                                    @if ($quotes->total() > 50)
                                        <span class="pl-0">Results: {{ $quotes->firstItem() }}-{{ $quotes->lastItem() }}
                                            of
                                            {{ $quotes->total() }}</span>
                                    @else
                                        @if ($quotes->firstItem() == $quotes->lastItem())
                                            <span class="pl-0">Results: {{ $quotes->firstItem() }} of
                                                {{ $quotes->total() }}</span>
                                        @else
                                            <span class="pl-0">Results:
                                                {{ $quotes->firstItem() }}-{{ $quotes->lastItem() }} of
                                                {{ $quotes->total() }}</span>
                                        @endif
                                    @endif
                                @endif
                                                                ...
                                                                <div class="iconDiv ml-4">
                                                                    <a href="javascript:;"
                                                                        ...
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="16" height="16" fill="#9C9C9C"
