...
div#swal2-html-container {padding: 30px 15px 0;}
...
@media (max-width: 375px) {
    ...
    .wd-cstm-check li {max-width: 50%; flex: 0 0 50%;}
}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="wd-profile-form">
                                <form action="{{ route('transporter.profile_post') }}" name="form_account" id="form_account" method="post" autocomplete="off" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="country_code" id="country_code" value="{{ empty($user->country_code) ? '+44' : $user->country_code }}">
                                    <!-- <h3>Profile</h3>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control sticky-data" placeholder="Username" name="username" value="{{$user->username}}" readonly>
                                            </div>
                                        </div>

                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Insurance cover £"  name="insurance_cover" value="{{$user->insurance_cover}}">
                                            </div>
                                        </div>

                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <textarea class="form-control" placeholder="Business description" name="business_description">{{$user->business_description??''}}</textarea>
                                            </div>
                                        </div>
                                    </div> -->
                                        ...
                                        <div class="info_sec">
                                            ...
                                            <div class="info_sec_details">
                                                <div class="info_sec_details_contant">
                                                    <p>In order to be one of our transport providers you need the following documents. This is to protect not only you but the customer from damage or loss. If you’re unable to provide these documents unfortunately your application will not be considered. If you have any questions about the required documents please email us 
                                                ...
                                                <div class="form-group">
                                                    <div class="document">
                                                        ...
                                                        <label for="driver_license" class="addmore_btn" id="add" title="Click to upload the document">
                                                            ...
                                                            <input type="file" accept=".pdf, .png, .jpg, .jpeg" name="driver_license" id="driver_license" style="display: none;">
                                                        </label>
                                                    </div>
                                                    <span id="driver_license_success" class="d-none success_msg" style="color: #52D017;">Uploaded Successfully</span>
                                                </div>
                                            </div>
                                            <div class="requied_sec_row">
                                                <div class="form-group">
                                                    <div class="document">
                                                        ...
                                                        <!-- <span>Goods in transit insurance</span> -->
                                                            ...
                                                            <input type="file" accept=".pdf, .png, .jpg, .jpeg" name="goods_in_transit_insurance" id="goods_in_transit_insurance" style="display: none;">
                                                        </label>
                                                    </div>
                                                    <span id="goods_in_transit_insurance_success" class=" success_msg d-none" style="color: #52D017;">Uploaded Successfully</span>
                                                </div>
                                            </div>
                                            <!-- <div class="requied_sec_row">
                                                <div class="form-group">
                                                    <div class="document">
                                                        <label for="motor_trade_insurance" class="addmore_btn" id="add" title="Click to upload the document">
                                                        Motor trade insurance
                                                            ...
                                                            <input type="file" accept=".pdf, .png, .jpg, .jpeg" name="motor_trade_insurance" id="motor_trade_insurance" style="display: none;">
                                                        </label>
                                                    </div>
                                                    <span id="motor_trade_insurance_success" class=" success_msg d-none" style="color: #52D017;">Upload Successful</span>
                                                </div>
                                            </div> -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="wd-admin-profile">
                                            <div class="admin-profile-top">
                                                <div class="admin-profile-area">
                                                    ...
                                                    <div>
                                                        <h2>{{$user->name}}</h2>
                                                        <a href="{{route('transporter.logout')}}" class="logout_txt mob_view font-weight-light">
                                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <g clip-path="url(#clip0_650_1110)">
                                                            <path d="M15.75 0H7.5C6.90381 0.00178057 6.33255 0.239405 5.91098 0.660977C5.48941 1.08255 5.25178 1.65381 5.25 2.25V6.75H12C12.5967 6.75 13.169 6.98705 13.591 7.40901C14.0129 7.83097 14.25 8.40326 14.25 9C14.25 9.59674 14.0129 10.169 13.591 10.591C13.169 11.0129 12.5967 11.25 12 11.25H5.25V15.75C5.25178 16.3462 5.48941 16.9175 5.91098 17.339C6.33255 17.7606 6.90381 17.9982 7.5 18H15.75C16.3462 17.9982 16.9175 17.7606 17.339 17.339C17.7606 16.9175 17.9982 16.3462 18 15.75V2.25C17.9982 1.65381 17.7606 1.08255 17.339 0.660977C16.9175 0.239405 16.3462 0.00178057 15.75 0Z" fill="white"></path>
                                                            <path d="M2.55772 9.75002H12.0002C12.1991 9.75002 12.3899 9.671 12.5305 9.53035C12.6712 9.38969 12.7502 9.19893 12.7502 9.00002C12.7502 8.8011 12.6712 8.61034 12.5305 8.46969C12.3899 8.32903 12.1991 8.25002 12.0002 8.25002H2.55772L3.53272 7.28252C3.67395 7.14129 3.75329 6.94974 3.75329 6.75002C3.75329 6.55029 3.67395 6.35874 3.53272 6.21752C3.39149 6.07629 3.19994 5.99695 3.00022 5.99695C2.80049 5.99695 2.60895 6.07629 2.46772 6.21752L0.217718 8.46752C0.0822483 8.61173 0.00683594 8.80215 0.00683594 9.00002C0.00683594 9.19788 0.0822483 9.3883 0.217718 9.53252L2.46772 11.7825C2.61133 11.9192 2.80198 11.9954 3.00022 11.9954C3.19845 11.9954 3.3891 11.9192 3.53272 11.7825C3.67323 11.6409 3.75208 11.4495 3.75208 11.25C3.75208 11.0505 3.67323 10.8591 3.53272 10.7175L2.55772 9.75002Z" fill="white"></path>
                                            ...
                                            <div class="wd-profl-botm mt-5 pt-4">
                                                <div class="wd-profl-lst">
                                                    <p>Jobs completed</p>
                                                    <span>{{$jobs_completed_count}}</span>
                                                </div>
                                    ...
                                    <div class="row">
                                        @if($user->driver_license != null)
                                            <div class="col-lg-6">
                                                <div class="form-group document-list">
                                                    <span>Valid driving license</span>
                                                    <a href="{{ url($user->driver_license) }}"class="view-pdf" data-toggle="modal" data-target="#pdfModal" data-url="{{ url($user->driver_license) }}" style="float:right">View</a>
                                                </div>
                                            </div>
                                        @endif
                                        @if($user->goods_in_transit_insurance != null)
                                            <div class="col-lg-6">
                                                <div class="form-group document-list">
                                                    <span>Goods in transit insurance</span>
                                                    <a href="{{ url($user->goods_in_transit_insurance) }}"class="view-pdf" data-toggle="modal" data-target="#pdfModal" data-url="{{ url($user->goods_in_transit_insurance) }}" style="float:right">View</a>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                    <!-- @if($user->motor_trade_insurance != null)
                                    <div class="document-item">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <a href="{{ url($user->motor_trade_insurance) }}" class="document-name" target="_blank" title="Click to see the document">Motor trade insurance</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endif -->
                                @endif
                                    ...
                                    <div class="row align-items-end adjust-space-mobile-padding">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control sticky-data" placeholder="Full name" name="name" value="{{$user->first_name}}" readonly>
                                            </div>

                                            <!-- <div class="form-group">
                                                <input type="text" class="form-control sticky-data" placeholder="Address" name="address" value="{{$user->town}} @if($user->town), {{$user->county}}@endif" readonly>
                                            </div> -->

                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Company name" name="company_name" id="company_name" value="{{$user->name}}">
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="tel" id="phone" class="form-control" placeholder="Mobile Phone" name="mobile" value="{{old('country_code',  ($user->country_code) ?? '' )}} {{old('mobile',  ($user->mobile) ?? '' )}}"/>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Change password" name="opassword" id="opassword">
                                            </div> -->
                                            <div class="form-group">
                                            ...
                                            <!-- <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Confirm new password" name="cpassword" id="cpassword">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="row adjust-space-mobile-padding">
                                        <div class="col-lg-6 order-lg-1 order-2">
                                            <h5 style="color:#717171; margin-bottom:10px;">Email notifications preferences:</h5>
                                        ...
                                        <div class="col-lg-6 order-lg-2 order-1" >
                                            <h5 style="color:#717171; margin-bottom:10px;">Payment methods:</h5>
                                            @php
