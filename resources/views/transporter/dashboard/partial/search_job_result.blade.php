        ...
        <div class="boxContentList">
            ...
            <div class="boxImg-text car-row" data-car-id="{{ $quote->id }}">
                <div class="imgCol">
                    ...
                    <div>
                        <img src="{{ $quote->image ? env('APP_URL') . '/' . $quote->image : env('APP_URL') . '/uploads/no_car_image.png' }}" class="vehicle_image" alt="image" />
                    </div>
                    @else
                        <div class="job_se_sec slider">
                            <div>
                                <img src="{{ $quote->image ?: '/uploads/no_car_image.png' }}" class="vehicle_image"
                                    alt="image" />
                            </div>
            ...
            <div class="contentBlockBtn">
                ...
                <div class="iconDiv">
                    <a href="javascript:;" class="" onclick="addToWatchlist('{{ $quote->id }}');"
...
@foreach ($quotes as $quote)
    <div class="boxContent">
        <div class="boxContentList">
            ...
            <div class="boxImg-text car-row" data-car-id="{{ $quote->id }}">
                <div class="imgCol">
                    <img src="{{ $quote->image ? env('APP_URL') . '/' . $quote->image : env('APP_URL') . '/uploads/no_car_image.png' }}" class="" alt="image" />
                </div>
