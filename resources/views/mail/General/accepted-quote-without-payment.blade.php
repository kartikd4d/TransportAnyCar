                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:25px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; margin-bottom: 16px;font-size:14px;">You recently clicked on ‘accept quote’ for the delivery of your {{$data['user_quotes']->vehicle_make}} {{$data['user_quotes']->vehicle_model}} but we haven’t received your deposit to secure the booking yet.</p>
                                                    <p style="margin: 0;font-size:14px;">If you still wish to have this transport job carried out then click the button below to pay the small deposit and secure the booking to avoid missing out.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:30px;padding-left:50px;padding-right:50px;padding-top:15px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                    <p style="margin: 0; margin-bottom: 16px;font-size:14px;"><strong>Note:</strong> Transporters can withdraw this quote without notice at any time due to busy schedules so make sure you don’t miss out.</p>
                                                    <p style="margin: 0; margin-bottom: 16px;font-size:14px;">Best regards,</p>
                                                    <p style="margin: 0;font-size:14px;">The Transport Any Car Team</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
