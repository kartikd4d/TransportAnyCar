                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    ...
                                                    <h3 style="font-size: 22px; line-height: normal;">Delivery <span style="color: #018dd4;">Expired</span></h3>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:60px;padding-right:60px;padding-top:25px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; margin-bottom: 16px;">We’re sorry that you didn't find any suitable quotes for you to accept.</p>
                                                    <p style="margin: 0;">If you still need to have your vehicle transported then feel free to post another listing.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
