												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
															...
															<td class="pad" style="width:100%;padding-top: 50px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<!-- <div style="max-width: 600px;">
																		<img src="{{asset('assets/images/new-transporter-signup.png')}}" style="display: block; height: auto; border: 0; width: 100%;" width="600" alt="Thank you for your application" title="Thank you for your application">
																	</div> -->
																	<a href="https://transportanycar.com/">
																	<img src="https://mcusercontent.com/8992880337eb54b5df095f667/images/91d6d431-803b-d338-b1ae-4ab578715e2c.jpg" style="display: block; height: auto; border: 0; width: 100px; margin: 15px auto;" alt="Thank you for your application" title="Thank you for your application"></a> 
																	<h3 style="font-size: 22px;line-height: normal;"><span style="color: #018dd4;">Welcome to</span><br> Transport Any Car </h3>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:15px;">
																<div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">Great news, your account is now active but you must upload the required documents within your profile and wait for approval before you can start bidding for transport jobs.</p>
																</div>
															</td>
														</tr>
													</table>
													<table class="paragraph_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:15px;">
																<div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">If you have any questions please don’t hesitate to contact us <strong><a data-link-card="true" href="mailto:info@transportanycar.com" target="_blank" style="text-decoration: underline; color: #000000;" rel="noopener">info@transportanycar.com</a></strong></p>
																</div>
															</td>
														</tr>
													</table>
