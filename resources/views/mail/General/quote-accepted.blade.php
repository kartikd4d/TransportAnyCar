...
<head>
    ...
    margin-bottom: 22px;
    display: flex;
    align-items: center;     font-family: 'Montserrat', sans-serif;font-size: 94%;
}
...
.collection_list b {
    ...
    color: #444;
        ...
        @media (max-width:620px) {
            ...
            #message-htmlpart1 div.rcmBody .v1jpbsrch_inner small{
                font-size: 11px;
            }
            #message-htmlpart1 div.rcmBody .v1jobsrch_info_list li span{
                font-size: 11px;
            }
            .collection_list b {
                width: 65%;
                            ...
                            <tr>
                                <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                    ...
                                    <table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                        <tr>
                                            <td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:30px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:23px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:27.599999999999998px;">
                                                    <p style="margin: 0; font-size: 18px;">Your offer of <strong>£{{ number_format($quote['transporter_payment'], 0) }}</strong> has been accepted by {{ $quote['username'] }}.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="paragraph_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:25px;padding-right:25px;padding-top:15px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; font-size: 15px;">Click the button below to contact the customer and make arrangements.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div class="alignment" align="center"><!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://transportanycar.com/" style="height:42px;width:181px;v-text-anchor:middle;" arcsize="72%" stroke="false" fillcolor="#52d017">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0px,0px,0px,0px">
                                                            <center style="color:#ffffff; font-family:sans-serif; font-size:16px">
                                                    <![endif]-->
                                                    <a href="{{ route('transporter.current_jobs', ['id' => $quote['quote_by_transporter_id']]) }}" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#52d017;border-radius:30px;width:auto;border-top:0px solid #8a3b8f;font-weight:400;border-right:0px solid #8a3b8f;border-bottom:0px solid #8a3b8f;border-left:0px solid #8a3b8f;padding-top:5px;padding-bottom:5px;font-family:'Montserrat', sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                        <span style="padding-left:50px;padding-right:50px;font-size:16px;display:inline-block;letter-spacing:normal;">
                                    ...
                                    <table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                        <tr>
                                            <td class="pad" style="padding-bottom:10px;padding-left:15px;padding-right:15px;padding-top:30px;">
                                                <div class="col-lg-12 coll_det" style="border-bottom: 1px solid #ccc; padding-bottom: 30px; margin-bottom: 30px;">
                                                    <div class="collection_details">
                                                        <h2>Collection details</h2>
                                                        <div class="collection_list">
                                                            <span>Contact name:</span>
                                                            <b>{{ $quote['quotation_detail']['collection_contact_name'] }}</b>
                                                        </div>
                                                        <div class="collection_list">
                                                            <span>Mobile number:</span>
                                                            <b>{{ $quote['quotation_detail']['collection_mobile_number'] }}</b>
                                                        </div>
                                                        <div class="collection_list">
                                                            <span>Email address:</span>
                                                            <b>{{ $quote['quotation_detail']['collection_email'] }}</b>
                                                        </div>
                                                        <div class="collection_list">
                                                            <span>Pickup address:</span>
                                                            @if($quote['quotation_detail']['collection_address'])
                                                                <b>{{ $quote['quotation_detail']['collection_address'] }}</b>
                                                            @else
                                                                <b>
                                                ...
                                                <div class="col-lg-12" style="border-bottom: 1px solid #ccc; padding-bottom: 30px; margin-bottom: 30px;">
                                                    <div class="collection_details">
                                                        <h2>Delivery details</h2>
                                                        <div class="collection_list">
                                                            <span>Contact name:</span>
                                                            <b>{{ $quote['quotation_detail']['delivery_contact_name'] }}</b>
                                                        </div>
                                                        <div class="collection_list">
                                                            <span>Mobile number:</span>
                                                            <b>{{ $quote['quotation_detail']['delivery_mobile_number'] }}</b>
                                                        </div>
                                                        <div class="collection_list">
                                                            <span>Email address:</span>
                                                            <b>{{ $quote['quotation_detail']['delivery_email'] }}</b>
                                                        </div>
                                                        <div class="collection_list">
                                                            <span>Delivery address:</span>
                                                            @if($quote['quotation_detail']['delivery_address'])
                                                                <b>{{ $quote['quotation_detail']['delivery_address'] }}</b>
                                                            @else
                                                                <b>
                                    ...
                                    <table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:15px;padding-right:15px;padding-top:30px;">
                                                <ul class="jobsrch_info_list" style="padding: 0; margin: 0;">
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span>{{ $quote['pickup_postcode'] ?? '-' }}</span>
                                                    </li>
                                                    <li>
                                                        <div class="jpbsrch_inner">
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:15px;padding-right:15px;padding-top:20px;">
                                                <div class="jobsrch_right_box">
                                                    <h4 class="distance_text" style="font-size: 18px; font-family: 'Montserrat', sans-serif; margin-bottom: 20px;";>Journey Distance: <b>{{$quote['distance']}}les</b>
                                                        <strong style="color: #898989;">({{$quote['duration']}})</strong>
                                                    </h4>
