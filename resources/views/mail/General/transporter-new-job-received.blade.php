                        ...
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; color: #000000; width: 600px; margin: 0 auto;" width="600">
                            ...
                            <tr>
                                <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:0px;padding-right:0px;padding-top:30px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; font-size: 20px; color: #000;  line-height: 1.3; ">Great news, you have received a new transport job.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table> -->
                                            ...
                                            <td class="pad" style="padding-bottom:20px;padding-left:15px;padding-right:15px;padding-top:30px;">
                                                <ul class="jobsrch_info_list" style="padding: 0; margin: 0;">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span style="width: 45%;">{{ $quote['how_moved'] }}</span>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:15px;padding-right:15px;padding-top:10px;">
                                                <div class="jobsrch_right_box">
                                                    <h4 class="distance_text" style="font-size: 15px; font-weight: bold; font-family: 'Montserrat', sans-serif; margin-bottom: 20px;  text-align: center;";>Journey Distance: <b>{{$quote['distance']}}les</b>
                                                    ...
                                                    <a href="{{route('transporter.new_jobs_new' , ['share_quotation' => $quote['id']])}}" class="make_offer_btn" style="background: #52D017; width: 100%;padding: 14px 20px;border-radius: 33px; display: block;text-align: center;font-size: 125%;color: #fff;text-decoration: none;font-family: 'Montserrat', sans-serif; margin-top: 10px;">Place Bid</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="paragraph_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                        <tr>
                                            <td class="pad" style="padding-bottom:15px;padding-left:15px;padding-right:15px;padding-top:15px;">
                                                <div style="background: #f1f1f1; padding: 30px 20px; color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                    <p style="margin: 0; margin-bottom: 50px;font-size: 120%; color: #000; line-height: 130%;"><strong style="display: block; color: #000; margin-bottom: 15px; font-size: 22px;">Important note:</strong> Please do not share any contact information, we will provide you with the customers contact details once they have accepted your quote.</p>
                                                    <p style="margin: 0; margin-bottom: 10px; font-size: 120%; color: #000; line-height: 130%;"><strong style="display: block; color: #000; margin-bottom: 15px; font-size: 22px;">How it works:</strong> You make an offer for the job(s) you wish to carry out and if the customer accepts your offer, we will then forward their contact details onto you straight away so that you can make arrangements, the customer will pay you in full directly via your preferred payment method.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:40px;padding-left:10px;padding-right:10px;padding-top:10px;">
                                                <div style="color:#ffffff;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                    ...
                                                    <p style="margin: 0;"><a href="{{route('transporter.profile', ['unsub' => true]) }}" target="_blank" style="text-decoration: underline;color: #5f5f5f;" rel="noopener">Unsubscribe from notifications</a></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
