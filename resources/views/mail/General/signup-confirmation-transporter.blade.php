                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    <div style="max-width: 600px;"><img src="https://image.optimite.email/wp-content/uploads/2024/02/Email-1-copy-2.png" style="display: block; height: auto; border: 0; width: 100%;" width="600" alt="Welcome to Transport Any Car" title="Welcome to Transport Any Car"></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:25px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0;">Thank you for joining our car transport network. We look forward to working with you and helping you grow your business by connecting you with new customers.&nbsp;</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
