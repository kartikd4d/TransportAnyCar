                                            ...
                                            <td class="pad" style="width:100%;">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    <!-- <div style="max-width: 600px;">
                                                        <img src="https://image.optimite.email/wp-content/uploads/2024/02/Email-6.png" style="display: block; height: auto; border: 0; width: 100%;" width="600" alt="New notification, it's great news!" title="New notification, it's great news!">
                                                    </div> -->
                                                    ...
                                                    <img src="https://mcusercontent.com/8992880337eb54b5df095f667/images/91d6d431-803b-d338-b1ae-4ab578715e2c.jpg" style="display: block; height: auto; border: 0; width: 100px; margin: 15px auto;" alt="accept quote deposit reminder" title="accept quote deposit reminder"></a>                                          
                                                    <h3 style="font-size: 22px; line-height: normal;">Quotes <span style="color: #018dd4;">summary</span></h3>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:30px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; margin-bottom: 16px;">You currently have {{$data['pendingQuotesCount']}} quotes for transporting your {{$data['quote']->vehicle_make}} {{$data['quote']->vehicle_model}}.</p>
                                                    <p style="margin: 0;">Don’t miss out, you can accept or decline the quotes by clicking the button below or message our transport providers to make arrangements.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
