    ...
    <main>
        <section class="join_network_main trans_forgotpass position-relative">
            <div class="container">
                ...
                <form class="other_forgot_account" action="{{route('admin.forgot_password_post')}}" name="form_forgot_password" id="form_forgot_password" method="post" autocomplete="off">
                    @csrf
                    <a href="{{route('admin.login')}}" class="backtologin">
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <a href="{{route('admin.login')}}" class="manual_link d-inline-block">Back to login</a>
                                </div>
                            </div>
